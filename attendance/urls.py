...
urlpatterns = [
    ...
    path('report/cycles/',
         views.report_attendance_cycles,
         name='report_attendance_cycles',
         ),
    path('report/cycles/<int:cycle_pk>/',
         views.report_cycle_attendance,
         name='report_cycle_attendance',
         ),
    path('report/students/',
         views.report_attendance_students,
         name='report_attendance_students',
         ),
    path('report/students/<int:student_pk>/',
         views.report_student_attendance,
